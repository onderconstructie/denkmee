...
def _messages_vraag(bron: str, themes: list[str], buurt_hint: str) -> tuple[str, str]:
    ...
    system = (
        ...
        "('er wordt gevraagd', 'werd geantwoord'). Verwijs daarna naar het raadslid met de familienaam "
        "of als 'het raadslid', nooit met 'hij', 'zij', 'hem' of 'haar': uit een naam leid je niet af "
        "hoe iemand aangesproken wil worden.\n"
